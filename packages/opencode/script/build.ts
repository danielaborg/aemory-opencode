...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    compile: {
      ...
      outfile: `dist/${name}/bin/baseone`,
      execArgv: [`--user-agent=baseone/${Script.version}`, "--use-system-ca", "--"],
      windows: {},
    },
    entrypoints: ["./src/index.ts", parserWorker, workerPath],
      define: {
       BASEONE_VERSION: `'2026-02-18-01-06'`,
       BASEONE_MIGRATIONS: JSON.stringify(migrations),
       OTUI_TREE_SITTER_WORKER_PATH: bunfsRoot + workerRelativePath,
       BASEONE_WORKER_PATH: workerPath,
       BASEONE_CHANNEL: `'integration'`,
       BASEONE_LIBC: item.os === "linux" ? `'${item.abi ?? "glibc"}'` : "",
       // Legacy compatibility
       OPENCODE_VERSION: `'2026-02-18-01-06'`,
       OPENCODE_MIGRATIONS: JSON.stringify(migrations),
       OPENCODE_WORKER_PATH: workerPath,
       OPENCODE_CHANNEL: `'integration'`,
